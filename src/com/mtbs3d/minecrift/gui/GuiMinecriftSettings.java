...
public class GuiMinecriftSettings extends BaseGuiSettings
{
	static VROption[] minecriftDeviceList = new VROption[]
    {
        ...
        new VROption(205,                             VROption.Position.POS_RIGHT,   3.5f,    VROption.ENABLED, "Head Orientation Tracking..."),
        new VROption(EnumOptions.VR_HEAD_POSITION,    VROption.Position.POS_LEFT,  4.5f, VROption.DISABLED, null),
        new VROption(207,                             VROption.Position.POS_RIGHT,   4.5f,    VROption.ENABLED, "Head Position Tracking..."),
        new VROption(EnumOptions.VR_CONTROLLER,       VROption.Position.POS_LEFT, 5.5f, VROption.DISABLED, null),
        new VROption(208,                             VROption.Position.POS_RIGHT,  5.5f,    VROption.ENABLED, "Move/Aim Control..."),
    };
